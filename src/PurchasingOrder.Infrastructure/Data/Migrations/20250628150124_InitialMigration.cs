        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseGoodId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PurchaseItemSerialNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseItems_PurchaseGoods_PurchaseGoodId",
                        column: x => x.PurchaseGoodId,
                        principalTable: "PurchaseGoods",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseItems_PurchaseGoodId",
                table: "PurchaseItems",
                column: "PurchaseGoodId");
